...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      program.uniforms.rot.value += dt * 0.15;
  ...
  return (
    <motion.div
      ref={ref}
      className="relative flex items-center justify-center min-h-screen overflow-hidden bg-black rounded-b-3xl"
    >
      ...
      >
        <motion.img
          ...
          alt="JZB Studio Logo"
          className="h-12 md:h-16 lg:h-40 mx-auto drop-shadow-lg"
